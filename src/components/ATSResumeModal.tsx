...
export const ATSResumeModal: React.FC<ATSResumeModalProps> = ({ isOpen, onClose, onShowToast }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-stone-950/80 backdrop-blur-sm flex items-center justify-center p-3 sm:p-6">
      <div className="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-2xl w-full max-w-4xl max-h-[92vh] flex flex-col shadow-2xl overflow-hidden transition-all">
        
        {/* Modal Header & Quick Actions Bar */}
        <div className="p-4 sm:px-6 bg-stone-100 dark:bg-stone-850 border-b border-stone-200 dark:border-stone-800 flex flex-wrap items-center justify-between gap-3 no-print">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-lg bg-teal-600/10 dark:bg-teal-500/20 text-teal-700 dark:text-teal-400 flex items-center justify-center">
          ...
          <div className="flex items-center gap-2">
            {/* View Mode Toggle */}
            <div className="flex items-center bg-stone-200 dark:bg-stone-800 p-1 rounded-lg text-xs">
              <button
            ...
            <button
              ...
              className="px-3 py-1.5 bg-teal-600 hover:bg-teal-700 text-white rounded-lg text-xs font-semibold flex items-center gap-1.5 transition shadow-xs"
            >
            ...
            <button
              ...
              className="p-1.5 text-stone-600 dark:text-stone-300 hover:bg-stone-200 dark:hover:bg-stone-800 rounded-lg transition"
            >
            ...
            <button
              id="ats-btn-close"
              onClick={onClose}
              className="p-1.5 text-stone-400 hover:text-stone-700 dark:hover:text-stone-200 rounded-lg transition ml-1"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
        ...
        <div className="overflow-y-auto p-6 sm:p-8 flex-1 bg-white dark:bg-stone-900">
          {viewMode === 'plaintext' ? (
            <div className="space-y-3">
              ...
              <textarea
                ...
                className="w-full h-[520px] bg-stone-50 dark:bg-stone-950 text-stone-800 dark:text-stone-200 font-mono text-xs p-4 rounded-xl border border-stone-200 dark:border-stone-800 focus:outline-none leading-relaxed select-all"
              />
            </div>
          ) : (
            /* Formatted High-Contrast Clean Resume Layout */
            <div className="max-w-3xl mx-auto space-y-6 text-stone-800 dark:text-stone-200 text-sm leading-relaxed">
              
              {/* Header */}
              <div className="border-b border-stone-200 dark:border-stone-800 pb-5 text-center sm:text-left sm:flex sm:items-start sm:justify-between">
                <div>
                  <h1 className="text-2xl font-bold tracking-tight text-stone-900 dark:text-white">
                    JOAN JHERIZALYN R. AROMIN
                  </h1>
                  <p className="text-teal-700 dark:text-teal-400 font-semibold text-sm mt-0.5">
                    IT Support Specialist • Technical Virtual Assistant • Junior Python Developer
                  </p>
                </div>

                <div className="mt-3 sm:mt-0 text-xs text-stone-500 dark:text-stone-400 space-y-1 sm:text-right font-mono">
                  ...
                  <div className="flex items-center gap-2 justify-center sm:justify-end text-teal-600 dark:text-teal-400 pt-1">
              ...
              <section className="space-y-2">
                <h2 className="text-xs font-bold uppercase tracking-wider text-stone-400 dark:text-stone-500 font-mono">
                  Professional Summary
                </h2>
                <p className="text-stone-700 dark:text-stone-300 text-xs sm:text-sm">
              ...
              <section className="space-y-2">
                ...
                <div className="grid grid-cols-1 gap-2 text-xs">
                  <div className="bg-stone-50 dark:bg-stone-850 p-2.5 rounded-lg border border-stone-200 dark:border-stone-800">
                    <strong className="text-stone-900 dark:text-white">IT Support & Systems:</strong> Windows 10/11/7 installation & troubleshooting, PC hardware assembly, hardware diagnostics, OS cloning, disk partitioning, formatting, device drivers, preventive maintenance, basic networking (LAN/IP setup), Active Directory fundamentals.
                  </div>
                  <div className="bg-stone-50 dark:bg-stone-850 p-2.5 rounded-lg border border-stone-200 dark:border-stone-800">
                    <strong className="text-stone-900 dark:text-white">Programming & Databases:</strong> Python 3, Tkinter GUI, SQLite, SQL Querying, Relational Database Design, OOP Architecture, HTML5, CSS3, JavaScript basics, Java basics, Git & GitHub.
                  </div>
                  <div className="bg-stone-50 dark:bg-stone-850 p-2.5 rounded-lg border border-stone-200 dark:border-stone-800">
                    <strong className="text-stone-900 dark:text-white">Administrative & Technical VA:</strong> MS Excel (Shortcuts, Formulas, Data Models), MS Word (Document Formatting, Legal archiving), Google Workspace (Docs, Sheets, Drive), BIR ORUS online registration & transactions, SSS/PhilHealth/Pag-IBIG portals, Calendar scheduling.
                  </div>
                </div>
              </section>
              ...
              <section className="space-y-3">
                ...
                <div className="space-y-3">
                  <div className="border-l-2 border-teal-600 pl-3 space-y-1">
                  ...
                  <div className="border-l-2 border-stone-300 dark:border-stone-700 pl-3 space-y-1">
                    <div className="flex items-center justify-between">
                      <h3 className="font-bold text-stone-900 dark:text-white text-xs sm:text-sm">
                    ...
                    <div key={exp.id} className="space-y-1 text-xs">
                      <div className="flex flex-wrap items-baseline justify-between gap-1">
                        <div>
                          ...
                          <span className="text-stone-500 dark:text-stone-400 font-medium"> — {exp.company}</span>
                        </div>
                        <span className="font-mono text-[11px] text-teal-700 dark:text-teal-400 font-semibold">
                          {exp.period} {exp.hours ? `(${exp.hours})` : ''}
                        </span>
                      </div>
                      <ul className="list-disc list-inside text-stone-600 dark:text-stone-300 space-y-0.5 pl-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 pt-2 border-t border-stone-200 dark:border-stone-800">
                <section className="space-y-2 text-xs">
                  ...
                  <div className="space-y-2">
                    <div>
                      ...
                      <div className="text-teal-700 dark:text-teal-400 font-medium">STI College Carmona (Batch 2026)</div>
                    </div>
                    <div>
                      <div className="font-semibold text-stone-800 dark:text-stone-200">
                        Information Technology Coursework
                      </div>
                      <div className="text-stone-500">IETI Alabang (2008 – 2009)</div>
                    </div>
                    <div>
                      <div className="font-semibold text-stone-800 dark:text-stone-200">
                        Computer Technician Certificate
                      </div>
                      <div className="text-stone-500">Alternative Learning Center (2005)</div>
                    </div>
                  </div>
                </section>
        ...
        {/* Modal Footer */}
        <div className="p-4 bg-stone-100 dark:bg-stone-850 border-t border-stone-200 dark:border-stone-800 flex flex-wrap items-center justify-between gap-3 text-xs text-stone-500 dark:text-stone-400 no-print">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={handleDownloadTxt}
              className="text-stone-700 dark:text-stone-300 hover:underline font-medium flex items-center gap-1"
            >
